$(document).ready(function () {
    ...
    $('#add-new-bl').click(function (e) {
        ...
        for (i = 0; i < 10; i++) {
            ...
            $("div#bl-payable-at").append("<select name='bl-payable-at'><option value='POD'>POD</option><option value='POL'>POL</option></select>" + "<br>" + "<br>");
            ...
            $("div#bl-line-detention-day-count").append("<label>Free for</label>" + "<input type='number' name='bl-line-detention-day-count'>" + "<br>");
        }
