$(document).ready(function () {
    ...
    $("div#header").find("h1").html(introductory_data["type"] + " containers");
    localStorage.clear();
    $("div#header").find("h3").html("Date: " + introductory_data["date"]);
    $("#container-table").find("thead tr:nth-child(1) th").html(introductory_data["type"] + " containers at different locations");
});