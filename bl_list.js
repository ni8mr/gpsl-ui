$(document).ready(function () {
    ...
    $('#add-new-bl').click(function (e) {
        ...
        for (i = 0; i < 10; i++) {
            ...
            $("div#bl-line-detention-day-count").append("<br>" + "<input type='number' name='bl-line-detention-day-count' placeholder='Enter days till which line detentaion is free'>" + "<br>");
        }
